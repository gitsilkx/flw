...
if($_REQUEST['del']):
  ...
  pageRedirect('order.list.php?menuid=102&menupid=101');
  exit();
endif;
/***********************End Delete**************************/
...
<div class="adminRight">
	<div id="loadingrefresh">
		...
		<div class="rightContBody">
			...
			<form name="restaurantorder" method="post" action="order.list.php?menuid=102&menupid=101" />
			...
			<select class="restManageNameDrop" name="sortby" id="sortby" size="1" onchange="document.restaurantorder.submit();">
                ...
                <form name="formListContainer" id="formListContainer" action="order.list.php?menuid=102&menupid=101">
...
//echo "'pending_".$row->OrderID."'";
                    ...
                    <select name="delivered"  onchange="$(this).attr('name','delivered_new');window.location = 'order.list.php?menuid=102&menupid=101&delivered_new='+$(this).val()">
					...
					<td align="center" class="listCont">
						<span class="EditDeleteButton">
							<a href="view_customer_order.php?menuid=102&menupid=101&OrderID=<?php echo $row->OrderID;?>">
